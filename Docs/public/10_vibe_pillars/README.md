...
Draft workspace for a paper on the core structural pillars of Vibe.

This folder develops a simple thesis: permissionless perpetuals for the long tail only work if three hard problems are solved together:
