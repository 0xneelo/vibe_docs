...
```
                    ...
                    LISTING
                       ...
                       /  \
                      /    \
                     / a Permissionless Intent-Based Derivatives Protocol \
                    / (over  \
                   /  time)   \
                  /____________\
                 /              \
...
This is precisely what the OTC 2 OB (`otc2ob`) hybrid is designed to do.
...
**The only solution is a hybrid architecture that traverses the design space as markets mature. In this paper, that architecture is the OTC 2 OB (`otc2ob`) hybrid.**

---

*Next Section: The OTC 2 OB Hybrid Architecture →*
