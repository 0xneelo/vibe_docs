# A Permissionless OTC Derivatives Protocol: Solving the Market Bootstrap Problem in Permissionless Perpetuals

## Paper Overview

This paper presents the approach of a Permissionless OTC Derivatives Protocol to solving one of the most critical challenges in cryptocurrency market infrastructure: the creation of permissionless perpetual futures markets.
...
| **5. Architecture** | [05-Architecture.md](./05-Architecture.md) | The OTC 2 OB (`otc2ob`) hybrid and its maturation process | 2 |
...
### The Solution
The OTC 2 OB (`otc2ob`) hybrid traverses the design space:
...
*A Permissionless OTC Derivatives Protocol for rule-based market creation*
