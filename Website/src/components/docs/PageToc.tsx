...
export function PageToc({ headings }: PageTocProps) {
  ...
  return (
    <aside className="sticky top-24 self-start">
      <div className="card-surface-sidebar flex max-h-[calc(100vh-7rem)] flex-col overflow-hidden">
        <div className="reader-scrollbar min-h-0 flex-1 overflow-y-auto overscroll-contain p-4">
